    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('type', Type\ChoiceType::class, [
                ...
                'choices' => [
                    'zentlix_main.attribute.string' => 'text',
                    'zentlix_main.attribute.textarea' => 'textarea',
                    'zentlix_main.attribute.email' => 'email',
                    'zentlix_main.attribute.password' => 'password',
                ],
            ])
            ->add('default', Type\TextType::class, [
                'label' => 'zentlix_main.attribute.default_value',
                'required' => false,
            ])
            ...
            ->add('sort', Type\IntegerType::class, [
                ...
                'data' => $command instanceof CreateCommand ?
                    $this->repository->getMaxSort($command->attributeEntity) + 1 : $command->sort,
                'constraints' => [
                    new GreaterThan(
