...
namespace Zentlix\MainBundle\UI\Http\Web\Form\Attribute\NumberType;
...
class Form extends AbstractForm
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('integer', Type\CheckboxType::class, [
                'label' => 'zentlix_main.attribute.integer',
            ])
